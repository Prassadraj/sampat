...
function Login() {
  return (
    <div className="flex w-full h-screen">
      <div className="flex-1 h-full" id="left">
        <div className="flex justify-center h-full items-center relative">
          ...
          <div className="flex flex-col items-center gap-3" id="title">
            <img src={title} width="60%" className="mb-20" alt="" />
          </div>
        </div>
      </div>
      <div className="flex-1 h-full" id="right">
        <div className="flex justify-center h-full items-center">
          <div className="absolute top-40 right-48 mr-1">
            <div>
              <h1 className="text-4xl font-semibold text-green-500">Welcome Back</h1>
            ...
            <button className="w-full text-white bg-slate-500 mt-10 rounded-xl" id="login">
              LOGIN
            </button>
            <div className="ml-4">
              <p className="text-gray-400 text-sm mt-32">
